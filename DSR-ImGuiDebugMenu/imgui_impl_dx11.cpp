...
bool    ImGui_ImplDX11_Init(void* hWnd, ID3D11Device* device, ID3D11DeviceContext* device_context)
{
    ...
    if ((ini = CreateFile(L"game.properties", GENERIC_READ, NULL, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL)) != INVALID_HANDLE_VALUE)
    {
        ...
        g_dbgMenuWidth = GetPrivateProfileInt(L"DbgMenu", L"Def.WindowSize.X", 450, L"./game.properties");
        g_dbgMenuHeight = GetPrivateProfileInt(L"DbgMenu", L"Def.WindowSize.Y", 600, L"./game.properties");
        g_dbgMenuPosX = GetPrivateProfileInt(L"DbgMenu", L"Def.WindowPos.X", 25, L"./game.properties");
        g_dbgMenuPosY = GetPrivateProfileInt(L"DbgMenu", L"Def.WindowPos.Y", 25, L"./game.properties");
    }
